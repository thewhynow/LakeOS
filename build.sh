...
# is debugging a bug that only occurs when built without debug flags
# and that is a fate that not even the most descipicable and evil of humans
# deserve to endure

x_flags="-std=c++98 -ffreestanding -D__is_libk -nostdlib -O0 -w -g"
c_flags="-std=gnu99 -ffreestanding -D__is_libk -nostdlib -O0 -w -Ikernel/include -Ilibc/include -g"
s_flags=""
q_flags=" -m 512"
